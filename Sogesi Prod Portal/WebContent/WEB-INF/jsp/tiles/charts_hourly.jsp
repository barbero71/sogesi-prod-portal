...
<br><br>
<c:if test="${(stabPon == 1) && (fn:contains(sessionScope.chartSessionFilter.stabId, '1')||sessionScope.chartSessionFilter.stabId=='all')}">
	...
	new Morris.Line({
		  ...
		  data: [
		    ...
		    { hours: '23:00', <c:out value="${pon23}" /> prev: 25500 },
		  ],
...
<c:if test="${(stabPsg == 1) && (fn:contains(sessionScope.chartSessionFilter.stabId, '2')||sessionScope.chartSessionFilter.stabId=='all')}">
	...
	new Morris.Line({
		  ...
		  data: [
		    ...
		    { hours: '09:00', <c:out value="${psg09}" /> prev: 3600 },
		    { hours: '10:00', <c:out value="${psg10}" /> prev: 4800 },
		    { hours: '11:00', <c:out value="${psg11}" /> prev: 7200 },
		    { hours: '12:00', <c:out value="${psg12}" /> prev: 9600 },
		    { hours: '13:00', <c:out value="${psg13}" /> prev: 12000 },
		    { hours: '14:00', <c:out value="${psg14}" /> prev: 14400 },
		    { hours: '15:00', <c:out value="${psg15}" /> prev: 16800 },
		    { hours: '16:00', <c:out value="${psg16}" /> prev: 19200 },
		    { hours: '17:00', <c:out value="${psg17}" /> prev: 21600 },
		    { hours: '18:00', <c:out value="${psg18}" /> prev: 24000 },
		    { hours: '19:00', <c:out value="${psg19}" /> prev: 26400 },
		    { hours: '20:00', <c:out value="${psg20}" /> prev: 28800 },
		    { hours: '21:00', <c:out value="${psg21}" /> prev: 31200 },
		    { hours: '22:00', <c:out value="${psg22}" /> prev: 33600 },
		    { hours: '23:00', <c:out value="${psg23}" /> prev: 36000 },
		  ],
		  // The name of the data record attribute that contains x-effs.
		  xkey: 'hours',
		  parseTime: false,
...
<c:if test="${(stabTer == 1) && (fn:contains(sessionScope.chartSessionFilter.stabId, '4')||sessionScope.chartSessionFilter.stabId=='all')}">
...
<script>
	new Morris.Line({
		  ...
		  data: [
				    ...
				    { hours: '23:00', <c:out value="${ter23}" /> prev: 29400 },
		  ],
		  // The name of the data record attribute that contains x-effs.
		  xkey: 'hours',
		  parseTime: false,
...
<c:if test="${(stabCan == 1) && (fn:contains(sessionScope.chartSessionFilter.stabId, '16')||sessionScope.chartSessionFilter.stabId=='all')}">
	...
	new Morris.Line({
		  ...
		  data: [
		    ...
		    { hours: '07:00', <c:out value="${can07}" /> prev: 1700 },
		    { hours: '08:00', <c:out value="${can08}" /> prev: 3400 },
		    { hours: '09:00', <c:out value="${can09}" /> prev: 5100 },
		    { hours: '10:00', <c:out value="${can10}" /> prev: 6800 },
		    { hours: '11:00', <c:out value="${can11}" /> prev: 8500 },
		    { hours: '12:00', <c:out value="${can12}" /> prev: 10200 },
		    { hours: '13:00', <c:out value="${can13}" /> prev: 11900 },
		    { hours: '14:00', <c:out value="${can14}" /> prev: 13600 },
		    { hours: '15:00', <c:out value="${can15}" /> prev: 15300 },
		    { hours: '16:00', <c:out value="${can16}" /> prev: 17000 },
		    { hours: '17:00', <c:out value="${can17}" /> prev: 18700 },
		    { hours: '18:00', <c:out value="${can18}" /> prev: 20400 },
		    { hours: '19:00', <c:out value="${can19}" /> prev: 22100 },
		    { hours: '20:00', <c:out value="${can20}" /> prev: 23800 },
		    { hours: '21:00', <c:out value="${can21}" /> prev: 25500 },
		    { hours: '22:00', <c:out value="${can22}" /> prev: 27200 },
		    { hours: '23:00', <c:out value="${can23}" /> prev: 28900 },
		  ],
		  // The name of the data record attribute that contains x-effs.
		  xkey: 'hours',
		  parseTime: false,
...
<!-- 
<div id="pippo" style="height: 250px;"></div>
<script>
	new Morris.Line({
		  // ID of the element in which to draw the chart.
		  element: 'pippo',
		  ...
		  // the chart.
		  data: [
		         	{ hours: '06:00', eff: 1, prev: 2 }, 
		         	{ hours: '07:00', eff: 2, prev: 4 }, 
		         	{ hours: '08:00', eff: 5, prev: 7 },
		  ],
		  // The name of the data record attribute that contains x-effs.
		  xkey: 'hours',
		  parseTime: false,
